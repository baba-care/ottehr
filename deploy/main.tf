...
module "ottehr_apps" {
  ...
  ehr_vars = {
    ...
    PROJECT_API_ZAMBDA_URL           = var.environment == "local" ? "http://localhost:3001/local" : "https://project-api.zapehr.com/v1"
  ...
  patient_portal_vars = {
    ...
    PROJECT_API_URL               = var.environment == "local" ? "http://localhost:3001/local" : "https://project-api.zapehr.com/v1"
